    ...
    <footer className="bg-dark-gray border-t border-light-gray/10 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-lg font-orbitron font-semibold mb-4">快速链接</h4>
          ...
          <div>
            <h4 className="text-lg font-orbitron font-semibold mb-4">资源中心</h4>
            <ul className="space-y-2">
              {resources.map((link) => (
                <li key={link.path}>
                  <Link
          ...
          <div>
            <h4 className="text-lg font-orbitron font-semibold mb-4">联系我们</h4>
            <ul className="space-y-2 text-light-gray">
              <li>地址：计算机学院大楼 501室</li>
              <li>电话：(010) 12345678</li>
              <li>邮箱：lab@computer.edu.cn</li>
              <li>邮编：100000</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-light-gray/10 mt-12 pt-8 text-center text-light-gray">
          <p>© 2026 计算机学院实验室. 保留所有权利.</p>
        </div>
      </div>
    </footer>
  );
